...
string1 = "Programming languages is definitely the best course I have taken in my entire undergraduate CS career!"
string2 = "Don’t OVERTHINK it!"

def wordsmith(String1, String2):
 words = String1.split()
